...
def main(args):
    ...
    train_loader, val_loader = get_loaders(str(args.dataset_path), batch_size=args.batch_size)
    print(f"Loaded training and validation loaders from {args.dataset_path}")
